...
public:
	...
	/*!
	 ...
	 \param NIF the nif number
	 \param phone the phone number
	 \param lastOperationp the last operation date
	 \param isinactive is true if customer is inactive, false otherwise
	 \param ID the id of the customer
	 */
	customer(string name, string birthDate, string address, string postalCode,
			nif NIF, long phone,  string lastOperationp, bool isinactive,unsigned int ID);
	// ******************************** Get Methods
	...
	//!return date of last operation
	date getLastOperation();
	//!return true if the customer is inactive
	bool isInactive();
	//! Set date the last Operation
	void setLastOperation(date new_date);
	//! Sets the account inactive status wit the given one
	void setInactive(bool t)
	{
		this->isInative=t;
	}
	//!Sets the selected agency number for the customer
	void setAgencyNumb(int num)
	{
		this->agencyNumb=num;
	};
	//!Returns the customer's agency number
	long getAgencyNumb()
	{
		return agencyNumb;
	};
...
public:
	...
	/*!
	 ...
	 \param postalCode the postal code string
	 \param NIF the nif number
	 \param BI the customer's BI number
	 \param phone the phone number
	 */
	 ...
	 */
	particular(string name, string birthDate, string address, string postalCode,
			nif NIF, long BI, long phone, string lastOperationp, bool isinactive, unsigned int ID);
	// ******************************** Get Methods
...
public:
	 ...
	 */
	company(string name, string birthDate, string address, string postalCode,
			nif NIF, long phone, double capital, string lastOperationp, bool isinactive, unsigned int ID);
	// ******************************** Set Methods
	//! set the capital
...
public:
	...
	/*!
	 ...
	 \param postalCode the postal code string
	 \param NIF the nif number
	 \param BI the employee's BI number
	 \param phone the phone number
