...
public:
  ...
  //! constructor that receives the data and the ID (used for loadFile)
  account(money initialDeposit, vector<int> &holders, unsigned int managerID,
      unsigned int ID);
  //! Total accounts
  ...
  //! == operator
  /*!
	\param id the id of the second account to compare
	\return returns true if the two accounts compared have the same ID, false otherwise
  */
  bool operator==(unsigned int id)
  {
    return this->ID == id;
  }
  //! get the bank that the account is associated to
  /*!
	\return returns the id of the bank the account is associated to
  */
  static int getBank()
  {
	  return bank;
  }
  //! get the agency that the account is associated to
  /*!
	\return returns the id of the agency the account is associated to
  */
...
public:
  ...
  //! constructor that receives the data and the ID (used in loadfile)
  Term(money initialDeposit, vector<int> &holders, int managerID,
...
public:
  ...
  //! constructor that receives the data and ID (used for loadfile)
  Order(money initialDeposit, vector<int> &holders, int managerID,
      unsigned int ID);
  //! Withdraw money
