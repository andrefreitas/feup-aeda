...
void test_1a_InicioJogo(){
	...
	estados.push_back(true);
	estados.push_back(false);
	estados.push_back(false);
	estados.push_back(false);
	estados.push_back(false);
	estados.push_back(true);
...
void runSuite(){
	cute::suite s;
	s.push_back(CUTE(test_1a_InicioJogo));
	s.push_back(CUTE(test_1b_EscreveJogo));
	s.push_back(CUTE(test_1c_FazJogada));
	s.push_back(CUTE(test_1d_MaisVisitado));
	s.push_back(CUTE(test_2a_CriaDicionario));
	s.push_back(CUTE(test_2b_ImprimeDicionario));
	s.push_back(CUTE(test_2c_ConsultaDicionario));
	s.push_back(CUTE(test_2d_CorrigeDicionario));
	cute::ide_listener lis;
	cute::makeRunner(lis)(s, "AEDA 2010/2011 - Aula Pratica 8");
}
